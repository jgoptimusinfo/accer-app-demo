...
tags = {
  ...
  "Application" = "msi-aks-eastus2"
  "ID"          = "00000001"
}

shared_resource_group_name = "msi-shared-dev-eus2-rg"

## ------------------------------------
##  Networking Configuration
## ------------------------------------

virtual_network_resource_group_name = "msi-nwsvcs-dev-eus2-rg"
virtual_network_address_space       = "10.20.0.0/16"
virtual_network_prefix_name         = "msi-nwsvcs-dev-eus2"
...
sql_config = {
  sql_server_name    = "msi-sql-dev-eus2-sql"
...
appag_umid_name       = "appag-dev-umi"
ssl_certificates_name = "generated-cert"

app_gateway_config = {
  name                = "msi-nwsvcs-dev-eus2-agw"
  public_ip_name      = "msi-nwsvcs-dev-eus2-pip"
  subnet_name_backend = "msi-nwsvcs-dev-eus2-snet-appgw"
}
...
backend_address_pools = {
  Pool1 = {
    name         = "msi-nwsvcs-dev-esus2-agw-rule-containers"
    ip_addresses = ["100.224.0.10"]
  },
  Pool2 = {
    name         = "msi-nwsvcs-dev-secondary-rule-containers"
...
backend_http_settings = {
  ...
  console-backend-settings-http = {
    name                  = "console-backend-settings-http"
    cookie_based_affinity = "Disabled"
    path                  = "/"
    enable_https          = false
    port                  = 8500
...
request_routing_rules = {
  console-prod-rule-https = {
    name                       = "console-dev-rule-https"
    rule_type                  = "Basic"
    http_listener_name         = "cfprdlistenerhttps"
    backend_address_pool_name  = "msi-nwsvcs-dev-secondary-rule-containers"
...
aks_resource_group_name = "msi-aks-dev-eus2-rg"
...
aks_config = {
  ...
  rbac_aad                          = false
  prefix                            = "msi-console-dev-eau2-aks"
