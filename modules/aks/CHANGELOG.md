...
- Remove prefix The name of the Node Pool which should be created within the Kubernetes Cluster. A random suffix of 4 characters is not used for this implementation .
